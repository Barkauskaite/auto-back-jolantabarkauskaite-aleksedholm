...
describe('Test suite', () => {
  ...
  it('test case 4  RoomCreate/Edit', () => {
    cy.login().then(cy.roomCreate).then(cy.editLastRoomID).then(cy.logout)
  })


  it('test case 5 RoomCreate/Delete ', () => {
    cy.login().then(cy.roomCreate).then(cy.delLastRoomID).then(cy.logout)
  })
  ...
  it('test case 8 ClientCreate/Edit ', () => {
    cy.login().then(cy.clientCreate).then(cy.editLastClientID).then(cy.logout)
  })


  it('test case 9 ClientCreate/Delete ', () => {
    cy.login().then(cy.clientCreate).then(cy.delLastClientID).then(cy.logout)
  })
