...
describe('Test suite', () => {
  ...
  it('test case 4  RoomCreate/Edit', () => {
    cy.login().then(cy.roomCreate).then(cy.roomEditLasatID).then(cy.logout)
  })


  it('test case 5 RoomCreate/Delete ', () => {
    cy.login().then(cy.roomCreate).then(cy.roomDelLastID).then(cy.logout)
  })
  ...
  it('test case 8 ClientCreate/Edit ', () => {
    cy.login().then(cy.clientCreate).then(cy.clientEditLastID).then(cy.logout)
  })


  it('test case 9 ClientCreate/Delete ', () => {
    cy.login().then(cy.clientCreate).then(cy.clientDelLastID).then(cy.logout)
  })
  ...
  it('test case EXTRA ', () => {
    cy.login().then(cy.getLastID).then(cy.logout)
  })
